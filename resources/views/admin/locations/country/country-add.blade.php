                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <a href="{{ route('countries') }}" class="btn btn-primary float-right">View countries</a>
                            <div class="basic-form">
                                <form action="{{ route('country_added') }}" method="POST">
                                    @csrf
                                    <br><br><br>
                                    @error('name')
                                    ...
                                    <button type="submit" class="btn mb-1 btn-dark">Add country</button>
                                </form>
                            </div>
                        </div>
                    </div>

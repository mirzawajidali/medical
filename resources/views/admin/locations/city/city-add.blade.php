                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <a href="{{ route('cities') }}" class="btn btn-primary float-right">View Cities</a>
                            <div class="basic-form">
                                <form action="{{ route('city_added') }}" method="POST">
                                    @csrf
                                    <br><br><br>
                                    @error('name')
                                    ...
                                    <button type="submit" class="btn mb-1 btn-dark">Add City</button>
                                </form>
                            </div>
                        </div>
                    </div>

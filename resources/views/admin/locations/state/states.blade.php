        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><i class="fas fa-users"></i> States </h4>
                            ...
                            @endif
                            <a href="{{ route('state_add') }}" class="btn btn-primary float-right">Add State</a>
                                ...
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/state-delete/'.$state->id) }}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
